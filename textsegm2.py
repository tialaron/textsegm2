...
spisok_doc = os.listdir('/app/textsegm2/original_docs/')

st.set_page_config(layout='wide')
st.header('Лабораторная работа:"Сегментация пяти типовых договоров".')
...
with col1:
  with st.container():
    ...
    filename1 = '/app/textsegm2/original_docs/'+spisok_doc[counter2]
...
with col2:
  with st.container():
    ...
    filename2 = '/app/textsegm2/modified_docs/'+spisok_doc[counter2]
